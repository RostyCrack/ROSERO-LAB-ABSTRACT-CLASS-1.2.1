...
public class CheckingTest {
    ...
    public void shouldNotProcessCheck() {
        ...
        assertFalse(account.processCheck(new Check(5000, LocalDate.now().minusMonths(1))));
        assertFalse(account.processCheck(new Check(4000, LocalDate.now().minusMonths(1))));
